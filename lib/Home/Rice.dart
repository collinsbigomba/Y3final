...
class _RiceState extends State<Rice> {
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        buildListItem('assets/m.jpeg', '150', ColorPallette().secondSlice),
        buildListItem('assets/grapes3.jpg', '200', ColorPallette().firstSlice)
      ],
    );
  }
}
...
class RiceDetails extends StatefulWidget {
  ...
  const RiceDetails({Key key, this.imgPath, this.headerColor})
      : super(key: key);

  @override
  _RiceDetailsState createState() => _RiceDetailsState();
}
