...
class Peas extends StatefulWidget {
  //const Peas({ Key? key }) : super(key: key);

  @override
  _PeasState createState() => _PeasState();
}

class _PeasState extends State<Peas> {
  @override
  Widget build(BuildContext context) {
    return ListView(
      children: [
        buildListItem('assets/m.jpeg', '150', ColorPallette().seventhSlice),
        buildListItem('assets/grapes3.jpg', '200', ColorPallette().eighthSlice)
      ],
    );
  }
}
...
class PeasDetails extends StatefulWidget {
  //const RiceDetails({ Key? key }) : super(key: key);
  final imgPath, headerColor;

  const PeasDetails({Key key, this.imgPath, this.headerColor})
      : super(key: key);

  @override
  _PeasDetailsState createState() => _PeasDetailsState();
}

class _PeasDetailsState extends State<PeasDetails> {
  @override
  Widget build(BuildContext context) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      'The pea is most commonly the small spherical seed or the seed-pod of the pod fruit Pisum sativum. Each pod contains several peas, which can be green or yellow. Botanically, pea pods are fruit, since they contain seeds and develop from the ovary of a (pea) flower. ... The average pea weighs between 0.1 and 0.36 gram.',
                      style: GoogleFonts.bigShouldersText(
                          color: Color(0xFFB5ABB8), fontSize: 13),
                    ),
                  ),
                  SizedBox(
                    height: 20,
