...
class Ginger extends StatefulWidget {
  //const Ginger({ Key? key }) : super(key: key);
...
class _GingerState extends State<Ginger> {
  ...
  Widget build(BuildContext context) {
    return ListView(
      children: [
        buildListItem('assets/m.jpeg', '150', ColorPallette().ninthSlice),
        buildListItem('assets/grapes3.jpg', '200', ColorPallette().tenthSlice)
      ],
    );
  }
}
...
class GingerDetails extends StatefulWidget {
  //const RiceDetails({ Key? key }) : super(key: key);
  final imgPath, headerColor;

  const GingerDetails({Key key, this.imgPath, this.headerColor})
      : super(key: key);

  @override
  _GingerDetailsState createState() => _GingerDetailsState();
}

class _GingerDetailsState extends State<GingerDetails> {
  @override
  Widget build(BuildContext context) {
