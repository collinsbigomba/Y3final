...
class Vinegar extends StatefulWidget {
  // const Vinegar({ Key? key }) : super(key: key);

  @override
  _VinegarState createState() => _VinegarState();
}

class _VinegarState extends State<Vinegar> {
  @override
  Widget build(BuildContext context) {
    return ListView(
      children: [
        buildListItem('assets/m.jpeg', '150', ColorPallette().sixthSlice),
        buildListItem('assets/grapes3.jpg', '200', ColorPallette().fifthSlice)
      ],
    );
  }
}
...
class VinegarDetails extends StatefulWidget {
  //const RiceDetails({ Key? key }) : super(key: key);
  final imgPath, headerColor;

  const VinegarDetails({Key key, this.imgPath, this.headerColor})
      : super(key: key);

  @override
  _VinegarDetailsState createState() => _VinegarDetailsState();
}

class _VinegarDetailsState extends State<VinegarDetails> {
  @override
  Widget build(BuildContext context) {
